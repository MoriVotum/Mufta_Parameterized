...
// Mufta.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMuftaApp, CWinApp)
...
// Единственный объект CMuftaApp

CMuftaApp theApp;


// Инициализация CMuftaApp

BOOL CMuftaApp::InitInstance()
{
